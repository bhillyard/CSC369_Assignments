...
# File paths
input_parquet_file = "2022_place_canvas_with_color_names.parquet"  # Input Parquet file
user_mapping_file = "user_mapping.parquet"                        # User mapping Parquet file
output_file_prefix = "chunk_"                                     # Prefix for chunk files
final_output_file = "2022_place_canvas_history_preprocessed.parquet"              # Final output file

# Connect to DuckDB
con = duckdb.connect()

# Set DuckDB to use multiple threads
con.execute("PRAGMA threads = 8;")  # Adjust this based on your CPU

# Step 1: Load the user mapping
...
# Step 2: Get the total number of rows in the input dataset
...
# Step 4: Combine all chunks into a single Parquet file with compression
